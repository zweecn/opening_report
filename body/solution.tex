...
%        事件源 & \multicolumn{1}{c}{状态类型} & 决策动作  & 决策后可能的状态 & $r^{[2]}$ & \multicolumn{1}{c}{$\Delta T$} & \multicolumn{1}{c}{$\Delta C$} \\
        
        \midrule
        
%        \multicolumn{1}{c}{$E_{31}$} 
%        & \multicolumn{1}{l}{${READY^U(T,C)}$}
%        & \multicolumn{1}{c}{终止}
%        & \multicolumn{1}{l}{$STOP(T,C+\Delta C)$} 
%        & \multicolumn{1}{c}{0} 
%        & \multicolumn{1}{c}{0} 
...
%------------------------------------------------------
    ...
    \begin{tablenotes}
        ...
        \item[3] $S_{ik}$~为替换后的服务或者重组后最先执行的服务。
