...
\begin{table}[htbp]
    ...
    \begin{tabular}{rrrrrrrr}
        \toprule
        \multicolumn{1}{c}{} & \multicolumn{1}{c}{状态类型} & \multicolumn{1}{c}{决策动作} & \multicolumn{1}{c}{决策后可能导致的状态} & \multicolumn{1}{c}{r [2]} & \multicolumn{1}{c}{DT} & \multicolumn{1}{c}{DC} \\
        \midrule
        \multicolumn{1}{c}{\multirow{9}[18]{*}{活动执行前的状态}} & \multirow{7}[14]{*}{READYU(T,C)} & \multicolumn{1}{c}{终止} & \multicolumn{1}{l}{STOP(T, C+DC)} & \multicolumn{1}{c}{0} & \multicolumn{1}{c}{0} & \multicolumn{1}{c}{\textit{fc}} \\
        ...
        \multicolumn{1}{c}{} &       & \multicolumn{1}{c}{} & \multicolumn{1}{l}{FAIL(T+DT,C+DC)} & \multicolumn{1}{c}{0} & \multicolumn{1}{c}{} & \multicolumn{1}{c}{} \\
        \multicolumn{1}{c}{\multirow{11}[22]{*}{活动执行后的状态}} & \multirow{7}[14]{*}{FAIL(T,C)} & \multicolumn{1}{c}{终止} & \multicolumn{1}{l}{STOP(T,C+DC)} & \multicolumn{1}{c}{0} & \multicolumn{1}{c}{0} & \multicolumn{1}{c}{\textit{fc}} \\
